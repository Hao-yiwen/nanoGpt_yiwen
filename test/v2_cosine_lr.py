# -*- coding: utf-8 -*-
"""
NanoGPT v5 - 中文歌词版本 (BPE 分词)

基于 v4.py，使用 SentencePiece BPE 分词替代字符级分词。
数据来源：ChineseLyrics
"""
...
TRAIN_ITERS = 10000      # 训练迭代次数
EVAL_ITERS = 200         # 评估时的迭代次数
EVAL_INTERVAL = 200      # 每隔多少步评估一次

# 模型架构相关
N_EMBED = 512            # 嵌入维度
N_HEADS = 8              # 注意力头数 (N_EMBED 必须能被 N_HEADS 整除，且商为偶数)
