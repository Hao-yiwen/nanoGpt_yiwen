...
# 训练相关
BATCH_SIZE = 64         # 每批样本数（96GB 显存 + AMP）
...
# ============================================================================
# v8 新增：批量化多头注意力 + Flash Attention
# ============================================================================
...
class Block(nn.Module):
    ...
    def __init__(self, n_embd, n_head):
        super().__init__()
        self.sa = CausalSelfAttention(n_embd, n_head)  # v8: 使用批量化注意力
...
if __name__ == '__main__':
    ...
    print(f"\n参数分组: decay={len(decay_params)}, no_decay={len(no_decay_params)}")
